...
test('eleventh lesson launches actual serve web with isolated guest port and link',async()=>{
 const {lessons}=await import('../public/tutorial.mjs');assert.equal(lessons.length,11);assert.equal(lessons[10].tasks[0][1],'tl serve web --port 8081 --auth none');
